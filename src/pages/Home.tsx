  ...
  return (
    <div className="container is-primary">
      ...
      <section className="section is-section-padding-large">
        ...
        <p className="subtitle is-3">On this web application you can search for locations and medical 
      ...
      <section className="section is-section-padding-large">
        ...
        <p className="subtitle is-3">We don't collect user data so there are no issues about it being leaked.</p>
      </section>
    </div>
  );
}
